...
- From field two, up to three black cats appear with independent 2–4 rescue timers. At zero, each bursts into smoke and stars: adjacent animals go home for goals but no points; wolves advance one extra step. Dashed outlines warn of the next burst. Pip quietly dismisses all cats instead. Cats and timers carry between fields.
