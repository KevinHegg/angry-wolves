...
(function(root) {
  ...
  const GAME_URL = 'https://kevinhegg.github.io/angry-wolves/play/2.1/';
  ...
  const api = {LIMIT,qualifies,verifiedRank,MODE,VERSION,URL,GAME_URL,BADGES,BADGE_NAMES,ANIMALS,encodeName,decodeName,payload,leaderboard,submit,caption};
