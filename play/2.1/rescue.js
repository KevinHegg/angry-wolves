  ...
  function showResults() {
    ...
    $('share-score').addEventListener('click',async()=>{
      ...
      try{
        ...
        $('share-status').textContent=outcome==='shared'?'Your share is ready.':outcome==='cancelled'?'Sharing cancelled. Your score is still here.':'Image sharing is unavailable in this browser. Use Copy score and game link.';
      }catch{if(ticket===dialogGeneration)$('share-status').textContent='Sharing could not open. Try again or copy your score and link.';}
