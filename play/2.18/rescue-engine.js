...
(function (root) {
  ...
  const CHAPTERS = [
    ...
    { name: 'Trouble in the orchard', time: 'Sunset', goal: [0, 18, 18, 0], types: 3, distance: 6,
    ...
    { name: 'The last gate', time: 'Nightfall', goal: [14, 14, 14, 14], types: 4, distance: 5,
      story: 'The barn lantern is lit. The pack is close. Cows will join as you make space. Bring 14 of every animal home, then shut the last gate.',
