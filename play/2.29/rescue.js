(() => {
  ...
  function commit() {
    ...
    setTimeout(()=>{
      ...
      if(state.status!=='playing'){
        ...
        setTimeout(()=>{if(ticket===generation)finishField();},reducedMotion.matches?350:windRotations.length?2700:900);
      }
  ...
  function finishField() {
    ...
    tone(state.chapter===2?'howl-plaintive':'win');
    if(state.chapter===2){
