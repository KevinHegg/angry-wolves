(() => {
  ...
  function commit() {
    ...
    setTimeout(()=>{
      ...
      if(busy&&state.status==='playing')setTimeout(()=>{if(ticket!==generation)return;busy=false;render();},2500);
      ...
      if(state.status!=='playing'){
        ...
        }else setTimeout(()=>{if(ticket!==generation)return;busy=false;finishField();},reducedMotion.matches?350:windRotations.length?2700:900);
      }
