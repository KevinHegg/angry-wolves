...
(function(root) {
  ...
  function payload(result, initials, badge) {
    return {
      ...
      missionTitle: `${result.challengeDate ? `Daily ${result.challengeDate} · ` : "Home safe · "}Pip rested ${result.rested}/3 · bonus ${result.bonus}`,
