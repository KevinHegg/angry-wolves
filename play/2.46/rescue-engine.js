...
(function (root) {
  ...
  function rescue(state, start, rng = Math.random) {
    ...
    let step = wolfStep(count) - pressure(state.moves) - preview.cats.length;
  ...
  const api = { SIZE, CAT, GOOD_CAT, DUST, isCat, isSpecial, WIND_SETTINGS, windRing, scatterWind, windGift, bestGift, catNeighbors, CAT_SETTINGS, CHAPTERS, REST_BONUSES, PRESSURE_THRESHOLDS, restBonus, wolfStep, herdPoints, pressure, neighbors, group, groups, create, rescue, bark, burstPreview };
