...
function redirect(target){return `<!doctype html><html lang="en"><meta charset="utf-8"><meta name="viewport" content="width=device-width,initial-scale=1"><title>Angry Wolves · Bring them home</title><link rel="canonical" href="https://kevinhegg.github.io/angry-wolves/"><meta http-equiv="refresh" content="0;url=${target}"><script>location.replace('${target}');</script><a href="${target}">Play Angry Wolves</a></html>\n`;}
